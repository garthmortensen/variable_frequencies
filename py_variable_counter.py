...
def get_python_patterns():
    ...
    patterns = {
        ...
        'var_name': re.compile(VAR_EXTRACTOR, re.VERBOSE)  # Used for extracting from multi-assigns
    }
    ...
    try:
        with open(file_path, 'r', encoding='utf-8', errors='ignore') as f:
            ...
            for match in patterns['equals'].finditer(content):
                ...
                if var not in ('if', 'while', 'for', 'elif', 'return', 'and', 'or', 
                               'not', 'is', 'in', 'None', 'True', 'False'):
